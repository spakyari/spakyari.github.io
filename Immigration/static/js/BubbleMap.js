...
// ----> Events <--------
  ...
  function RefreshMap(params) {
    ...
    if (params.by == "State")
      ...
      {
        var url = `${API}api/v1.0/immigrants_by_state/${country}/${params.year}/${params.top}`;
        var n = 0;
      }
      ...
      {
        var url = `${API}api/v1.0/immigrants_by_county/${country}/${params.year}/${params.top}`;
        var n = 1;
      };
  ...
  function Populate_DropDowns() {
    ...
    var APIs = {
      "region": `${API}/api/v1.0/regions`,
      "country": `${API}/api/v1.0/countries`,
      "year": `${API}/api/v1.0/years`
